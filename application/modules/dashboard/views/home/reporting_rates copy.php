                 ...
                 <table class="table table-bordered">
                   ...
                   foreach ($facility->staff as $staff): ?>
                    <tr> 
                       ...
                       <td rowspan="2" <?php if($q1_vals->score != null){  echo "style='font-weight:bold; color:#FFF';"; echo @getColorBasedOnPerformance($q1_vals->score,$q1_vals->data_target);}?> >
                        <?= round($q1_vals->score, 0) ?>
                        </td>
                        <td rowspan="2"><?= $q1_vals->data_target ?></td>
                        <td><?= $q2_vals->numerator ?>
                        </td>
                        <td rowspan="2" <?php if ($q2_vals->score!=null) { echo @getColorBasedOnPerformance($q2_vals->score, $q2_vals->data_target);
                        } ?>>
                        ...
                        <td rowspan="2" <?php if ($q3_vals->score!= null) {
                        ...
                        <td rowspan="2" <?php if ($q4_vals->score!=null) {
