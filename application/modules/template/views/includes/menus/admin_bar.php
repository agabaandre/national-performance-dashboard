   <a href="<?php echo base_url(); ?>person/index" class="btn btn-success btn-outline" style="margin-right:5px; margin-top:0px  <?php if ($this->uri->segment(2) == "summary") { ?> display:none;<?php } ?>">
       Send Report
   </a>
   <?php if ($this->session->userdata('user_type') == 'admin') { ?>
       <a href="<?php echo base_url(); ?>files/file" class="btn btn-success btn-outline" style="margin-right:5px; margin-top:0px  <?php if ($this->uri->segment(2) == "summary") { ?> display:none;<?php } ?>">
           Upload Data
       </a>
       ...
       <div class="dropdown">
           ...
           <a href="<?php echo base_url(); ?>files/file" class="btn btn-success btn-outline dropdown-toggle" data-toggle="dropdown" aria-expanded="true" style="margin-right:5px;">
               Admin Settings
           </a>
