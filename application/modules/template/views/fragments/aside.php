...
<aside class="page-sidebar">
    <div class="page-logo">
        <a href="#" class="page-logo-link press-scale-down d-flex align-items-center position-relative"
            ...
            <img src="<?= base_url() ?>assets/images/moh.png" alt="SmartAdmin WebApp" aria-roledescription="logo">
            <span class="page-logo-text mr-1">Staff Performance</span>
    ...
    <nav id="js-primary-nav" class="primary-nav" role="navigation">
        ...
        <div class="info-card">
            ...
            <img src="<?= base_url() ?><?php echo $this->session->userdata('image'); ?>" class="profile-image rounded-circle" alt="IMG">
